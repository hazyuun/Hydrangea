...
#define SYSCALL_0(eax) \
  syscall_0((int)(eax))
#define SYSCALL_1(eax,ebx) \
  syscall_1((int)(eax), (int)(ebx))
#define SYSCALL_2(eax,ebx,ecx) \
  syscall_2((int)(eax), (int)(ebx), (int)(ecx))
...
#define SYSCALL_5(eax,ebx,ecx,edx,esi,edi) \
  syscall_5((int)(eax), (int)(ebx), (int)(ecx), (int)(edx), (int)(esi), (int)(edi))
