...
void vesa_init(multiboot_info_t *mb) {
  vesa_fb = (uint32_t *)mb->framebuffer_addr;
  vesa_width = mb->framebuffer_width;
  vesa_height = mb->framebuffer_height;
  vesa_pitch = mb->framebuffer_pitch;
  vesa_bpp = mb->framebuffer_bpp;
}
